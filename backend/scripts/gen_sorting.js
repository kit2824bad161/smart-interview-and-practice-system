...
const sorting = [
  // Easy 1
  {
    ...
    constraints: ['1 <= n <= 1000', '-10^4 <= nums[i] <= 10^4'],
    examples: [{ input: '5\n5 1 4 2 8', output: '1 2 4 5 8', explanation: 'Sorted in ascending order.' }],
    starterCode: {
    ...
    solution: { approach: 'Repeatedly swap adjacent inverted elements.', timeComplexity: 'O(N^2)', spaceComplexity: 'O(1)' }
  },
  // Easy 2
  {
    ...
    examples: [{ input: '4\n64 25 12 22', output: '12 22 25 64', explanation: 'Sorted order.' }],
    starterCode: {
    ...
    testCases: [
      { input: '4\n64 25 12 22', expectedOutput: '12 22 25 64' },
      { input: '2\n2 1', expectedOutput: '1 2' }
    ],
    solution: { approach: 'Repeatedly find minimum element from unsorted part and place at beginning.', timeComplexity: 'O(N^2)', spaceComplexity: 'O(1)' }
  },
  // Easy 3
  {
    ...
    outputFormat: 'Print the sorted array.',
    constraints: ['1 <= n <= 1000'],
    examples: [{ input: '5\n12 11 13 5 6', output: '5 6 11 12 13', explanation: 'Sorted elements.' }],
    starterCode: {
    ...
    solution: { approach: 'Build sorted array in-place one element at a time.', timeComplexity: 'O(N^2)', spaceComplexity: 'O(1)' }
  },
  // Easy 4
  {
    ...
    examples: [
      ...
      { input: '4\n2 1 3 4', output: 'false', explanation: '2 > 1.' }
    ],
    starterCode: {
    ...
    testCases: [
      ...
      { input: '4\n2 1 3 4', expectedOutput: 'false' },
      { input: '1\n100', expectedOutput: 'true' }
    ],
    solution: { approach: 'Check if every adjacent pair satisfies a[i] <= a[i+1].', timeComplexity: 'O(N)', spaceComplexity: 'O(1)' }
  },
  // Medium 1
  {
    ...
    solution: { approach: 'Sort by start time, merge greedily when next start <= current end.', timeComplexity: 'O(N log N)', spaceComplexity: 'O(N)' }
  },
  // Medium 2
  {
    title: 'Sort Colors',
    ...
    examples: [{ input: '6\n2 0 2 1 1 0', output: '0 0 1 1 2 2', explanation: 'Sorted 0s, 1s, and 2s.' }],
    starterCode: {
    ...
    solution: { approach: 'Dutch National Flag algorithm with three pointers.', timeComplexity: 'O(N)', spaceComplexity: 'O(1)' }
  },
  // Medium 3
  {
    ...
    solution: { approach: 'Min-heap of size k to maintain k largest elements.', timeComplexity: 'O(N log K)', spaceComplexity: 'O(K)' }
  },
  // Hard 1
  {
    title: 'Maximum Gap',
    ...
    testCases: [
      { input: '4\n3 6 9 1', expectedOutput: '3' },
      { input: '1\n10', expectedOutput: '0' }
    ],
    solution: { approach: 'Bucket sort / radix sort pigeonhole principle.', timeComplexity: 'O(N)', spaceComplexity: 'O(N)' }
  },
  // Hard 2
  {
    ...
    constraints: ['1 <= nums.length <= 10^5'],
    examples: [{ input: '4\n5 2 6 1', output: '2 1 1 0', explanation: 'To right of 5: 2 and 1 (2). To right of 2: 1 (1). To right of 6: 1 (1).' }],
    starterCode: {
    ...
    testCases: [
      { input: '4\n5 2 6 1', expectedOutput: '2 1 1 0' },
      { input: '1\n-1', expectedOutput: '0' }
    ],
    solution: { approach: 'Merge sort with index tracking or Binary Indexed Tree (Fenwick Tree).', timeComplexity: 'O(N log N)', spaceComplexity: 'O(N)' }
  },
  // Hard 3
  {
    ...
    examples: [{ input: '6\n1 5 1 1 6 4', output: '1 6 1 5 1 4', explanation: 'One valid wiggle sort.' }],
    starterCode: {
    ...
    testCases: [
      { input: '6\n1 5 1 1 6 4', expectedOutput: '1 6 1 5 1 4' }
    ],
    solution: { approach: 'Sort and interleave lower and upper halves from end to avoid adjacent duplicates.', timeComplexity: 'O(N log N)', spaceComplexity: 'O(N)' }
  }
];

saveTopic('sorting.js', sorting);
