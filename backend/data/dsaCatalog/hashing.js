module.exports = [
  {
    ...
    "slug": "hashing-contains-duplicate",
    "topic": "Hashing",
    "difficulty": "Easy",
    ...
    "solution": {
      "approach": "HashSet insertion check.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(N)"
    }
  },
  {
    ...
    "slug": "hashing-intersection-of-two-arrays",
    "topic": "Hashing",
    "difficulty": "Easy",
    "problemStatement": "Given two integer arrays nums1 and nums2, return an array of their intersection. Each element in the result must be unique and returned in sorted order.",
    "inputFormat": "First line: n and m. Second line: n integers. Third line: m integers.",
    "outputFormat": "Print sorted unique intersection elements.",
    "constraints": [
      "1 <= n, m <= 1000"
    ],
    "examples": [
      {
        "input": "4 5\n1 2 2 1\n2 2 3 2 4",
        "output": "2",
        "explanation": "Intersection is 2."
      },
      {
        "input": "3 5\n4 9 5\n9 4 9 8 4",
        "output": "4 9",
        "explanation": "Sorted intersection."
      }
    ],
    "starterCode": {
  ...
  },
  {
    ...
    "slug": "hashing-find-all-disappeared-numbers",
    "topic": "Hashing",
    "difficulty": "Easy",
    "problemStatement": "Given an array nums of n integers where nums[i] is in the range [1, n], return an array of all the integers in the range [1, n] that do not appear in nums in ascending order.",
    "inputFormat": "First line: n. Second line: n integers.",
    "outputFormat": "Print missing numbers separated by space.",
    "constraints": [
      "1 <= n <= 10^5"
    ],
    "examples": [
      {
        "input": "8\n4 3 2 7 8 2 3 1",
        "output": "5 6",
        "explanation": "5 and 6 do not appear."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Boolean existence map.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(N)"
    }
  },
  {
    ...
    "slug": "hashing-unique-number-of-occurrences",
    "topic": "Hashing",
    "difficulty": "Easy",
    ...
    "examples": [
      {
        "input": "6\n1 2 2 1 1 3",
        "output": "true",
        "explanation": "1 has 3, 2 has 2, 3 has 1 occurrence."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Count frequencies and test set uniqueness of counts.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(N)"
    }
  },
  {
    ...
    "slug": "hashing-longest-consecutive-sequence",
    "topic": "Hashing",
    "difficulty": "Medium",
    ...
    "examples": [
      {
        "input": "6\n100 4 200 1 3 2",
        "output": "4",
        "explanation": "Sequence is [1, 2, 3, 4] with length 4."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Start expanding consecutive runs only from sequence start values.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(N)"
    }
  },
  {
    ...
    "slug": "hashing-subarray-sum-equals-k",
    "topic": "Hashing",
    "difficulty": "Medium",
    ...
    "solution": {
      "approach": "Prefix sum hash map counting occurrences of sum - k.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(N)"
    }
  },
  {
    ...
    "slug": "hashing-top-k-frequent-elements",
    "topic": "Hashing",
    "difficulty": "Medium",
    "problemStatement": "Given an integer array nums and an integer k, return the k most frequent elements in descending order of frequency.",
    "inputFormat": "First line: n and k. Second line: n integers.",
    "outputFormat": "Print k elements separated by space.",
    "constraints": [
    ...
    "examples": [
      {
        "input": "6 2\n1 1 1 2 2 3",
        "output": "1 2",
        "explanation": "1 has freq 3, 2 has freq 2."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Hash map frequency count with bucket sort or max heap.",
  ...
  },
  {
    ...
    "slug": "hashing-insert-delete-getrandom-o1",
    "topic": "Hashing",
    "difficulty": "Hard",
    "problemStatement": "Implement a structure supporting insert, remove, and size queries in O(1) average time. Given q operations: 1 x (insert x, prints true/false if already present), 2 x (remove x, prints true/false), 3 (print current size).",
    "inputFormat": "First line: q. Next q lines: operation.",
    "outputFormat": "Print results on new lines.",
    "constraints": [
      "1 <= q <= 10^4"
    ],
    "examples": [
      {
        "input": "4\n1 1\n2 2\n1 2\n3",
        "output": "true\nfalse\ntrue\n2",
        "explanation": "Insert 1 (true), remove 2 (false), insert 2 (true), size 2."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "HashMap + dynamic array with swap-with-last element removal.",
      "timeComplexity": "O(1)",
      "spaceComplexity": "O(N)"
    }
  },
  {
    ...
    "slug": "hashing-max-points-on-a-line",
    "topic": "Hashing",
    "difficulty": "Hard",
    ...
    "solution": {
      "approach": "Reduce dx and dy by their GCD as slope map keys.",
  ...
  },
  {
    ...
    "slug": "hashing-longest-substring-two-distinct",
    "topic": "Hashing",
    "difficulty": "Hard",
    "problemStatement": "Given a string s, return the length of the longest substring that contains at most two distinct characters.",
    ...
    "examples": [
      {
        "input": "eceba",
        "output": "3",
        "explanation": "\"ece\" has length 3."
      },
      {
        "input": "ccaabbb",
        "output": "5",
        "explanation": "\"aabbb\" has length 5."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Sliding window with character index hash map.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  }
