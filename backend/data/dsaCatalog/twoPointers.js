module.exports = [
  {
    ...
    "slug": "two-pointers-two-sum-ii",
    "topic": "Two Pointers",
    "difficulty": "Easy",
    "problemStatement": "Given a 1-indexed array of integers numbers that is already sorted in non-decreasing order, find two numbers such that they add up to a specific target number. Return 1-based indices.",
    "inputFormat": "First line: n. Second line: n sorted integers. Third line: target.",
    "outputFormat": "Print two 1-based indices separated by space.",
    "constraints": [
      "2 <= n <= 3 * 10^4"
    ],
    "examples": [
      {
        "input": "4\n2 7 11 15\n9",
        "output": "1 2",
        "explanation": "2 + 7 = 9 at index 1 and 2."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Two pointers converging from ends.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "slug": "two-pointers-squares-of-sorted-array",
    "topic": "Two Pointers",
    "difficulty": "Easy",
    ...
    "outputFormat": "Print sorted squared values.",
    "constraints": [
      "1 <= n <= 10^4"
    ],
    "examples": [
      {
        "input": "5\n-4 -1 0 3 10",
        "output": "0 1 9 16 100",
        "explanation": "Squared and sorted."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Two pointers comparing absolute values from outer ends.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(N)"
    }
  },
  {
    ...
    "slug": "two-pointers-is-subsequence",
    "topic": "Two Pointers",
    "difficulty": "Easy",
    ...
    "examples": [
      {
        "input": "abc\nahbgdc",
        "output": "true",
        "explanation": "All characters of s exist in t in order."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Two pointers greedy match.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "examples": [
      {
        "input": "hello",
        "output": "holle",
        "explanation": "e and o are reversed."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Two pointers scanning inwards for vowels.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "slug": "two-pointers-container-with-most-water",
    "topic": "Two Pointers",
    "difficulty": "Medium",
    "problemStatement": "Find two lines that together with the x-axis form a container, such that the container contains the most water. Return the maximum amount of water.",
    ...
    "examples": [
      {
        "input": "9\n1 8 6 2 5 4 8 3 7",
        "output": "49",
        "explanation": "Max area is between height 8 and 7, width 7 -> 49."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Two pointers advancing shorter wall.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    "title": "3Sum",
    "slug": "two-pointers-3sum",
    "topic": "Two Pointers",
    "difficulty": "Medium",
    "problemStatement": "Given an integer array nums, return the number of unique triplets [nums[i], nums[j], nums[k]] such that i != j, i != k, and j != k, and nums[i] + nums[j] + nums[k] == 0.",
    "inputFormat": "First line: n. Second line: n space-separated integers.",
    "outputFormat": "Print count of unique triplets.",
    "constraints": [
      "3 <= n <= 3000"
    ],
    "examples": [
      {
        "input": "6\n-1 0 1 2 -1 -4",
        "output": "2",
        "explanation": "Triplets: [-1,-1,2] and [-1,0,1]."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Sort array and run two-pointer search for each element.",
  ...
  },
  {
    ...
    "slug": "two-pointers-sort-by-parity-ii",
    "topic": "Two Pointers",
    "difficulty": "Medium",
    ...
    "inputFormat": "First line: n. Second line: n space-separated integers.",
    "outputFormat": "Print arranged elements separated by spaces.",
    "constraints": [
      "2 <= n <= 20000"
    ],
    "examples": [
      {
        "input": "4\n4 2 5 7",
        "output": "4 5 2 7",
        "explanation": "Even indices have even numbers, odd have odd."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Two pointers iterating through even and odd indices.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "slug": "two-pointers-trapping-rain-water",
    "topic": "Two Pointers",
    "difficulty": "Hard",
    ...
    "inputFormat": "First line: n. Second line: n space-separated integers.",
    "outputFormat": "Print total trapped rain water.",
    "constraints": [
      "1 <= n <= 2 * 10^4"
    ],
    "examples": [
    ...
    "solution": {
      "approach": "Two pointers tracking leftMax and rightMax boundaries.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    "title": "4Sum",
    "slug": "two-pointers-4sum",
    "topic": "Two Pointers",
    "difficulty": "Hard",
    "problemStatement": "Given an array nums of n integers and target, return count of unique quadruplets summing to target.",
    "inputFormat": "First line: n and target. Second line: n space-separated integers.",
    "outputFormat": "Print count of unique quadruplets.",
    "constraints": [
      "4 <= n <= 200"
    ],
    "examples": [
      {
        "input": "6 0\n1 0 -1 0 -2 2",
        "output": "3",
        "explanation": "Three unique quadruplets."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Two nested loops with inner two-pointer search.",
  ...
  },
  {
    ...
    "slug": "two-pointers-subarrays-with-k-different-integers",
    "topic": "Two Pointers",
    "difficulty": "Hard",
    "problemStatement": "Given an integer array nums and an integer k, return the number of good subarrays. A good array is an array where the number of different integers in that array is exactly k.",
    "inputFormat": "First line: n and k. Second line: n space-separated integers.",
    "outputFormat": "Print number of good subarrays.",
    "constraints": [
    ...
    "examples": [
      {
        "input": "5 2\n1 2 1 2 3",
        "output": "7",
        "explanation": "7 subarrays have exactly 2 distinct integers."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Exact(K) = atMost(K) - atMost(K-1) using sliding two-pointers.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(K)"
    }
  }
