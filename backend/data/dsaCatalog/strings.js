module.exports = [
  {
    ...
    "solution": {
      "approach": "Character frequency counter array of size 26.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "solution": {
      "approach": "Two pointers checking alphanumeric characters from both ends.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "solution": {
      "approach": "Horizontal scanning by progressively shortening the common prefix.",
      "timeComplexity": "O(S)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "solution": {
      "approach": "Two-pointer swap from ends towards center.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "solution": {
      "approach": "Sliding window with hash map storing last visited index of each character.",
      "timeComplexity": "O(N)",
  ...
  },
  {
    ...
    "examples": [
      {
        ...
        "output": "3",
        "explanation": "Groups are [\"bat\"], [\"nat\",\"tan\"], [\"ate\",\"eat\",\"tea\"]."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Canonical form using sorted character strings as map keys.",
  ...
  },
  {
    ...
    "examples": [
      ...
      },
      {
        "input": "   -42",
        "output": "-42",
        "explanation": "Whitespace ignored."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Skip leading spaces, check optional sign, accumulate digits and clamp overflow.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "solution": {
      "approach": "Two-pointer sliding window tracking required character count.",
  ...
  },
  {
    ...
    "examples": [
      ...
      },
      {
        "input": "e",
        "output": "false",
        "explanation": "Exponent without digits."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Deterministic finite state automaton / flag checking.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "solution": {
      "approach": "Stack initialized with boundary index -1.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(N)"
    }
  }
