module.exports = [
  {
    ...
    "slug": "bst-search-in-bst",
    "topic": "Binary Search Tree",
    "difficulty": "Easy",
    "problemStatement": "Given the root node of a binary search tree (BST) and a value val, return \"true\" if the node exists in the BST, otherwise return \"false\".",
    "inputFormat": "First line: n and val. Second line: n space-separated BST values.",
    ...
    "examples": [
      {
        "input": "5 2\n4 2 7 1 3",
        "output": "true",
        "explanation": "2 exists in the BST."
      },
      {
        "input": "5 5\n4 2 7 1 3",
        "output": "false",
        "explanation": "5 is not in the BST."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "BST property: if val < root go left, if val > root go right.",
      "timeComplexity": "O(H)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "inputFormat": "First line: n, low, high. Second line: n BST values.",
    "outputFormat": "Print sum of values in range.",
    "constraints": [
      "1 <= n <= 2 * 10^4"
    ],
    "examples": [
      {
        "input": "6 7 15\n10 5 15 3 7 18",
        "output": "32",
        "explanation": "Nodes 7, 10, 15 are in range: 7 + 10 + 15 = 32."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Prune recursion branches that fall completely outside [low, high].",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(H)"
    }
  },
  {
    ...
    "inputFormat": "First line: n. Second line: n space-separated BST values.",
    "outputFormat": "Print min absolute difference.",
    "constraints": [
      "2 <= n <= 10^4"
    ],
    "examples": [
      {
        "input": "5\n4 2 6 1 3",
        "output": "1",
        "explanation": "Min difference is |2 - 1| = 1."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "In-order traversal yields sorted values; compare adjacent nodes.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(H)"
    }
  },
  {
    ...
    "topic": "Binary Search Tree",
    "difficulty": "Easy",
    "problemStatement": "Given a binary search tree (BST), find the lowest common ancestor (LCA) node of two given nodes p and q.",
    "inputFormat": "First line: n, p, q. Second line: n BST values.",
    ...
    "solution": {
      "approach": "Split point where p and q diverge to left and right children is the LCA.",
      "timeComplexity": "O(H)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "slug": "bst-validate-bst",
    "topic": "Binary Search Tree",
    "difficulty": "Medium",
    "problemStatement": "Given the root of a binary tree represented as level-order values, return \"true\" if it is a valid binary search tree (BST), or \"false\" otherwise.",
    ...
    "examples": [
      ...
      },
      {
        "input": "5\n5 1 4 -1 -1 3 6",
        "output": "false",
        "explanation": "Node 4 < root 5 in right subtree."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Check that in-order traversal is strictly increasing.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(H)"
    }
  },
  {
    ...
    "inputFormat": "First line: n and k. Second line: n values.",
    "outputFormat": "Print kth smallest value.",
    "constraints": [
      "1 <= k <= n <= 10^4"
    ],
    "examples": [
    ...
    "solution": {
      "approach": "In-order traversal visits nodes in ascending order, stop at index k.",
  ...
  },
  {
    ...
    "slug": "bst-delete-node-in-bst",
    "topic": "Binary Search Tree",
    "difficulty": "Medium",
    "problemStatement": "Given a root node reference of a BST and a key, delete the node with the given key in the BST. Print the remaining nodes in sorted order.",
    "inputFormat": "First line: n and key. Second line: n BST values.",
    "outputFormat": "Print sorted remaining node values.",
    "constraints": [
      "0 <= n <= 10^4"
    ],
    "examples": [
    ...
    "testCases": [
      {
        "input": "6 3\n5 3 6 2 4 7",
        "expectedOutput": "2 4 5 6 7"
      }
    ],
    "solution": {
      "approach": "Replace deleted node with in-order successor or predecessor.",
      "timeComplexity": "O(H)",
      "spaceComplexity": "O(H)"
    }
  },
  {
    ...
    "slug": "bst-recover-bst",
    "topic": "Binary Search Tree",
    "difficulty": "Hard",
    "problemStatement": "You are given the root of a binary search tree (BST), where the values of exactly two nodes of the tree were swapped by mistake. Recover the tree and print the two swapped values in ascending order.",
    "inputFormat": "First line: n. Second line: n values.",
    "outputFormat": "Print the two swapped values in ascending order separated by space.",
    "constraints": [
      "2 <= n <= 1000"
    ],
    "examples": [
      ...
      },
      {
        "input": "4\n3 1 4 2",
        "output": "2 3",
        "explanation": "Swapped nodes are 2 and 3."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "In-order traversal detecting the two inversions.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "slug": "bst-construct-from-preorder",
    "topic": "Binary Search Tree",
    "difficulty": "Hard",
    "problemStatement": "Given an array of integers preorder, which represents the preorder traversal of a BST, construct the tree and return its in-order traversal (which is sorted).",
    "inputFormat": "First line: n. Second line: n preorder values.",
    "outputFormat": "Print in-order sorted elements.",
    "constraints": [
      "1 <= n <= 100"
    ],
    "examples": [
      {
        ...
        "explanation": "Inorder of any BST is sorted."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "BST inorder is the sorted permutation of its preorder.",
  ...
  },
  {
    ...
    "slug": "bst-bst-to-greater-sum-tree",
    "topic": "Binary Search Tree",
    "difficulty": "Hard",
    "problemStatement": "Given the root of a Binary Search Tree (BST), convert it to a Greater Tree such that every key of the original BST is changed to the original key plus the sum of all keys greater than the original key in BST. Print resulting values sorted.",
    "inputFormat": "First line: n. Second line: n BST values.",
    "outputFormat": "Print resulting values in ascending order.",
    "constraints": [
      "1 <= n <= 100"
    ],
    "examples": [
      {
        "input": "3\n4 1 6",
        "output": "6 10 11",
        "explanation": "Converted greater tree values: 6, 10, 11."
      }
    ],
    "starterCode": {
    ...
    "testCases": [
      {
        "input": "3\n4 1 6",
        "expectedOutput": "6 10 11"
      }
    ],
    "solution": {
      "approach": "Reverse in-order traversal (Right -> Root -> Left) accumulating running sum.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(H)"
    }
  }
