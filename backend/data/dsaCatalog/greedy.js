module.exports = [
  {
    ...
    "topic": "Greedy",
    "difficulty": "Easy",
    "problemStatement": "Assume you are an awesome parent and want to give your children some cookies. Each child i has a greed factor g[i], and each cookie j has size s[j]. Maximize the number of your content children.",
    "inputFormat": "First line: n and m. Second line: n children greeds. Third line: m cookie sizes.",
    "outputFormat": "Print number of content children.",
    "constraints": [
      "1 <= n, m <= 3 * 10^4"
    ],
    "examples": [
      {
        "input": "3 2\n1 2 3\n1 1",
        "output": "1",
        "explanation": "Only 1 child can be content."
      },
      {
        "input": "2 3\n1 2\n1 2 3",
        "output": "2",
        "explanation": "Both children content."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Sort both arrays and greedily satisfy smallest greed factors first.",
  ...
  },
  {
    ...
    "slug": "greedy-lemonade-change",
    "topic": "Greedy",
    "difficulty": "Easy",
    "problemStatement": "At a lemonade stand, each lemonade costs $5. Customers pay with a $5, $10, or $20 bill. Return \"true\" if you can provide every customer with correct change, else \"false\".",
    "inputFormat": "First line: n. Second line: n customer payments.",
    ...
    "examples": [
      {
        "input": "5\n5 5 5 10 20",
        "output": "true",
        "explanation": "All customers served."
      },
      {
        "input": "5\n5 5 10 10 20",
        "output": "false",
        "explanation": "Cannot provide change for $20."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Greedily prefer giving $10+$5 change over three $5 bills for $20 payment.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "slug": "greedy-max-units-on-truck",
    "topic": "Greedy",
    "difficulty": "Easy",
    "problemStatement": "You are assigned to put some amount of boxes onto one truck. You are given a 2D array boxTypes where boxTypes[i] = [numberOfBoxes_i, numberOfUnitsPerBox_i] and an integer truckSize. Return the maximum total units.",
    "inputFormat": "First line: n and truckSize. Next n lines: boxes and units.",
    "outputFormat": "Print max units.",
    "constraints": [
      "1 <= n <= 1000"
    ],
    "examples": [
      {
        "input": "3 4\n1 3\n2 2\n3 1",
        "output": "8",
        "explanation": "1 box of 3 units + 2 boxes of 2 units + 1 box of 1 unit = 8."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Fractional knapsack greedy by highest units per box.",
  ...
  },
  {
    ...
    "slug": "greedy-buy-max-stocks",
    "topic": "Greedy",
    "difficulty": "Easy",
    "problemStatement": "In a stock market, on day i (1-indexed), you can buy at most i stocks at price arr[i]. Given total budget k, calculate the maximum number of stocks you can buy.",
    "inputFormat": "First line: n and k. Second line: n stock prices.",
    "outputFormat": "Print max stocks bought.",
    "constraints": [
      "1 <= n <= 10^4"
    ],
    "examples": [
      {
        "input": "3 45\n10 7 19",
        "output": "4",
        "explanation": "Buy 1 on day 1 (10) and 2 on day 2 (14), total 24 <= 45. Stocks: 1+2+1=4."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Greedily sort by lowest price first.",
      "timeComplexity": "O(N log N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "examples": [
      ...
      },
      {
        "input": "5\n3 2 1 0 4",
        "output": "false",
        "explanation": "Will always arrive at index 3."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Greedy forward scan tracking farthest reachable index.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "topic": "Greedy",
    "difficulty": "Medium",
    "problemStatement": "There are n gas stations along a circular route, where the amount of gas at the ith station is gas[i]. You have a car with an unlimited gas tank and it costs cost[i] of gas to travel to station i + 1. Return the starting gas station's index if you can travel around once, or -1.",
    "inputFormat": "First line: n. Second line: n gas amounts. Third line: n costs.",
    ...
    "solution": {
      "approach": "Reset start index whenever prefix tank runs negative.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "outputFormat": "Print count of intervals to remove.",
    "constraints": [
      "1 <= n <= 10^5"
    ],
    "examples": [
    ...
    "solution": {
      "approach": "Sort by end time (interval scheduling greedy strategy).",
      "timeComplexity": "O(N log N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "topic": "Greedy",
    "difficulty": "Hard",
    "problemStatement": "There are n children standing in a line. Each child is assigned a rating value. Each child must have at least one candy, and children with higher rating get more candies than neighbors. Return minimum total candies.",
    "inputFormat": "First line: n. Second line: n ratings.",
    "outputFormat": "Print minimum candies.",
    "constraints": [
      "1 <= n <= 2 * 10^4"
    ],
    "examples": [
      {
        "input": "3\n1 0 2",
        "output": "5",
        "explanation": "Allocations: [2, 1, 2] sum = 5."
      },
      {
        "input": "3\n1 2 2",
        "output": "4",
        "explanation": "Allocations: [1, 2, 1] sum = 4."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Two passes (left-to-right then right-to-left) taking max satisfying both neighbors.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(N)"
    }
  },
  {
    ...
    "slug": "greedy-min-refueling-stops",
    "topic": "Greedy",
    "difficulty": "Hard",
    "problemStatement": "A car starts with startFuel liters of fuel. Distance to target miles. Given stations where station[i] = [position, fuel]. Return minimum number of refueling stops to reach target, or -1.",
    "inputFormat": "First line: target, startFuel, n. Next n lines: pos and fuel.",
    "outputFormat": "Print min stops or -1.",
    "constraints": [
    ...
    "examples": [
      {
        "input": "1 1 0",
        "output": "0",
        "explanation": "No stops needed."
      },
      {
        "input": "100 10 4\n10 60\n20 30\n30 30\n60 40",
        "output": "2",
        "explanation": "Stop at 10 and 60."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Max-heap of accessible stations, refueling greedily from station with most fuel.",
      "timeComplexity": "O(N log N)",
      "spaceComplexity": "O(N)"
    }
  },
  {
    ...
    "topic": "Greedy",
    "difficulty": "Hard",
    "problemStatement": "There are n different online courses numbered from 1 to n. Each course i has duration and lastDay. Return the maximum number of courses that you can take.",
    "inputFormat": "First line: n. Next n lines: duration and lastDay.",
    "outputFormat": "Print max courses.",
    "constraints": [
      "1 <= n <= 10^4"
    ],
    "examples": [
    ...
    "solution": {
      "approach": "Sort by deadline and greedily drop longest course from max-heap if deadline exceeded.",
      "timeComplexity": "O(N log N)",
      "spaceComplexity": "O(N)"
    }
  }
