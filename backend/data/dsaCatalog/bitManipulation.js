module.exports = [
  ...
  },
  {
    ...
    "examples": [
      ...
      },
      {
        "input": "128",
        "output": "1",
        "explanation": "128 in binary is 10000000, which has 1 one."
      }
    ],
    "starterCode": {
    ...
    "examples": [
      {
        "input": "2",
        "output": "2",
        "explanation": "0->0, 1->1, 2->1. Sum = 0+1+1 = 2."
      },
      {
        "input": "5",
        "output": "7",
        "explanation": "0->0, 1->1, 2->1, 3->2, 4->1, 5->2. Sum = 7."
      }
    ],
    "starterCode": {
      "java": "import java.util.*;\n\npublic class Main {\n    public static void main(String[] args) {\n        Scanner sc = new Scanner(System.in);\n        int n = sc.nextInt();\n        // Write your solution here\n    }\n}",
  ...
  },
  {
    ...
    "examples": [
      ...
      },
      {
        "input": "0 0",
        "output": "0",
        "explanation": "Range [0, 0] produces 0."
      },
      {
        "input": "1 2147483647",
        "output": "0",
        "explanation": "Most bits are flipped across this large range, result is 0."
      }
    ],
    "starterCode": {
    ...
    "examples": [
      {
        "input": "3 2\\n1 2 3",
        "output": "2",
        "explanation": "Subsets: [2] (XOR=2) and [1, 3] (1^3=2)."
      },
      {
        "input": "2 0\\n4 4",
        "output": "1",
        "explanation": "Subset [4, 4] XORs to 0."
      }
    ],
    "starterCode": {
      "java": "import java.util.*;\n\npublic class Main {\n    public static void main(String[] args) {\n        Scanner sc = new Scanner(System.in);\n        int n = sc.nextInt();\n        int k = sc.nextInt();\n        int[] nums = new int[n];\n        for(int i = 0; i < n; i++) nums[i] = sc.nextInt();\n        // Write your solution here\n    }\n}",
  ...
  },
  {
    ...
    "examples": [
      ...
      {
        "input": "7\\n14 70 53 83 49 91 36",
        "output": "127",
        "explanation": "Maximum XOR between pairs is 127."
      }
    ],
    "starterCode": {
    ...
    "examples": [
      {
        "input": "3\\n4 14 2",
        "output": "6",
        "explanation": "4=(0100), 14=(1110), 2=(0010). dist(4,14)=2, dist(4,2)=2, dist(14,2)=2. Total=6."
      },
      {
        "input": "3\\n4 14 4",
        "output": "4",
        "explanation": "dist(4,14)=2, dist(4,4)=0, dist(14,4)=2. Total = 4."
      }
    ],
    "starterCode": {
  ...
  },
  {
    ...
    "examples": [
      ...
      },
      {
        "input": "3\\n1 1 1",
        "output": "3",
        "explanation": "Triplets: (0,1,1), (1,2,2), (0,2,2) - all valid."
      }
    ],
    "starterCode": {
