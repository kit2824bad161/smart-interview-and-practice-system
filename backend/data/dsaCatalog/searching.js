module.exports = [
  {
    ...
    "solution": {
      "approach": "Single pass scanning every element.",
      "timeComplexity": "O(N)",
      "spaceComplexity": "O(1)"
    }
  },
  ...
  },
  {
    ...
    "solution": {
      "approach": "Lower bound binary search returning left insertion index.",
      "timeComplexity": "O(log N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "solution": {
      "approach": "Flatten 2D matrix conceptually into 1D sorted array and binary search.",
  ...
  },
  {
    ...
    "solution": {
      "approach": "Modified binary search determining which half is sorted.",
      "timeComplexity": "O(log N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "solution": {
      "approach": "Two separate binary searches for first and last occurrences.",
      "timeComplexity": "O(log N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "solution": {
      "approach": "Binary search comparing mid and mid + 1.",
      "timeComplexity": "O(log N)",
      "spaceComplexity": "O(1)"
    }
  },
  {
    ...
    "solution": {
      "approach": "Binary search on partition points of smaller array.",
  ...
  },
  {
    ...
    "examples": [
      {
        "input": "5 2\n7 2 5 10 8",
        "output": "18",
        "explanation": "Split into [7,2,5] and [10,8], largest is 18."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Binary search on answer domain [max(nums), sum(nums)].",
  ...
  },
  {
    ...
    "examples": [
      {
        "input": "2 2\n1 4\n3 2",
        "output": "0 1",
        "explanation": "4 at (0,1) is greater than 1 and 2."
      }
    ],
    "starterCode": {
    ...
    "solution": {
      "approach": "Binary search on columns, finding max element of column in O(M).",
